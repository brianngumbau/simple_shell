...
/**
 * clear_info - initializes info_x struct
 * @info: struct address or its parameter
 */
...
/**
 * set_info - initializes info_x struct
 * @info: struct address
 * @av: array (argument vector)
 */
 ...
 * @info: struct address
 * @all: if “all” parameter is set to true free all fields in the struct
 */
